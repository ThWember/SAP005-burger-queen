          ...
          <div className="subscribe-data">
            <form>
              <div className="email-sub-data">
                <label>EMAIL</label>
                <input type="text" placeholder="Insira seu email" value={newEmail} onChange={(event) => setNewEmail(event.target.value)}/>
              </div>
              <div className="password-sub-data">
                <label>SENHA</label>
                <input type="password" placeholder="Insira sua senha" autoComplete="off" value={newPassword} onChange={(event) => setNewPassord(event.target.value)}/>
              </div>
